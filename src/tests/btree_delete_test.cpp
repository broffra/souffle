...
TEST(Performance, Basic) {
    ...
    using t2 = btree_delete_set<Entry, detail::comparator<Entry>, std::allocator<Entry>, 256,
            detail::linear_search>;
    checkPerformance(t2, "souffle btree_delete_set - 256 - linear", in, out);

    using t3 = btree_delete_set<Entry, detail::comparator<Entry>, std::allocator<Entry>, 256,
